...
import { moneyPsychicsAdvisors } from "@/Advisors_Components/JsonData"
...
export default function Love() {
  ...
  const [popupFormData, setPopupFormData] = useState({
    ...
    partnerPlaceOfBirth:"",
      ...
      const [first, setFirst] = useState(false)
         ...
         const [data, setData] = useState(moneyPsychicsAdvisors)
      ...
      const handlePuch = ()=>{
        navigate("/love-astrologer-detail")
      }
  ...
  return (
    <>
      <CategoryHeader
        title="Love"
        description="Our Love specialists can see and interpret the colors and energies surrounding you, providing insights into your emotional, mental, and spiritual state."
          ...
          <Card className="border-2 border-gray-200 bg-white shadow-lg">
                  ...
                  <CardContent className="space-y-4">
                    <form onSubmit={handleBirthChartSubmit} className="space-y-2">
                     <div className="grid grid-cols-1 min-[850px]:grid-cols-2 gap-4">
                      <div className=" space-y-4">
                        <p className="text-lg font-semibold text-gray-700 mt-2">Enter Your Birth Details</p>
                       <div>
                        <Input
                          placeholder="Name"
                     ...
                     <div className=" space-y-4 max-[850px]:border-t max-[850px]:pt-4 min-[850px]:border-l min-[850px]:pl-4 border-gray-200">
                      <p className="text-lg font-semibold text-gray-700 mt-2">Enter Your Partner Birth Details</p>
                       <div>
                        <Input
                          placeholder="Name"
                          value={birthChartData.partnername}
                          onChange={(e) => setBirthChartData({ ...birthChartData, partnername: e.target.value })}
                          className="h-10 bg-white border-gray-300 text-gray-700 placeholder:text-gray-400"
                        />
                      </div>
                      ...
                      <div>
                        <Select
                          value={birthChartData.partnergender}
                          onValueChange={(value) => setBirthChartData({ ...birthChartData, partnergender: value })}
                        >
                          <SelectTrigger className="h-12 bg-white border-gray-300 text-gray-700">
                            <SelectValue placeholder="Male" />
                          </SelectTrigger>
                      ...
                      <div className="grid grid-cols-3 gap-3">
                        <div className="space-y-2">
                          ...
                          id="birthDay"
                          placeholder="25"
                          value={birthChartData.partnerbirthDay}
                          onChange={(e) => setBirthChartData({ ...birthChartData, partnerbirthDay: e.target.value })}
                          className="h-10 bg-white border-gray-300 text-gray-700 placeholder:text-gray-400"
                        />
                        </div>
                        <div className="space-y-2">
                          ...
                          id="birthMonth"
                          placeholder="5"
                          value={birthChartData.partnerbirthMonth}
                          onChange={(e) => setBirthChartData({ ...birthChartData, partnerbirthMonth: e.target.value })}
                          className="h-10 bg-white border-gray-300 text-gray-700 placeholder:text-gray-400"
                        />
                        </div>
                       <div className="space-y-2">
                          <Label htmlFor="birthYear" >BirthYear</Label>
                           ...
                           id="birthYear"
                          placeholder="2025"
                          value={birthChartData.partnerbirthYear}
                          onChange={(e) => setBirthChartData({ ...birthChartData, partnerbirthYear: e.target.value })}
                          className="h-10 bg-white border-gray-300 text-gray-700 placeholder:text-gray-400"
                        />
                       </div>
                      </div>
                      ...
                      <div className="grid grid-cols-3 gap-3">
                          ...
                          <Label htmlFor="birthHour" >BirthHour</Label>
                           ...
                           id="birthHour"
                          placeholder="15"
                          value={birthChartData.partnerbirthHour}
                          onChange={(e) => setBirthChartData({ ...birthChartData, partnerbirthHour: e.target.value })}
                          className="h-10 bg-white border-gray-300 text-gray-700 placeholder:text-gray-400"
                        />
                       </div>
                            <div className="space-y-2">
                          ...
                          id="birthMinute"
                          placeholder="5"
                          value={birthChartData.partnerbirthMinute}
                          onChange={(e) => setBirthChartData({ ...birthChartData, partnerbirthMinute: e.target.value })}
                          className="h-10 bg-white border-gray-300 text-gray-700 placeholder:text-gray-400"
                        />
                       </div>
                            <div className="space-y-2">
                         ...
                         id="birthSeconds"
                          placeholder="26"
                          className="h-10 bg-white border-gray-300 text-gray-700 placeholder:text-gray-400"
                           onChange={(e) => setBirthChartData({ ...birthChartData, partnerbirthSeconds: e.target.value })}
                        />
                       </div>
                      ...
                      <div>
                        <Input
                          placeholder="Birth place"
                          value={birthChartData.partnerbirthPlace}
                          onChange={(e) => setBirthChartData({ ...birthChartData, partnerbirthPlace: e.target.value })}
                          className="h-10 bg-white border-gray-300 text-gray-700 placeholder:text-gray-400"
                        />
                      </div>
                     </div>
...
<DialogContent className="w-full max-w-lg rounded-xl bg-white p-6 shadow-xl z-50">
    <div className="p-4">
      <h2 className="text-xl font-semibold mb-4 text-center">
       Love Form  with {selectedPsychic?.name}
      </h2>
  <form
  onSubmit={async (e) => {
    e.preventDefault();
...
>
  ...
  <div className="grid grid-cols-2 gap-3">
    <Input
      type="date"
      required
      value={popupFormData.yourBirthDate}
      onChange={(e) =>
        setPopupFormData({ ...popupFormData, yourBirthDate: e.target.value })
      }
    />
    <Input
      type="time"
      value={popupFormData.yourBirthTime}
      onChange={(e) =>
        setPopupFormData({ ...popupFormData, yourBirthTime: e.target.value })
      }
    />
  </div>
  ...
  <Input
    ...
    required
    value={popupFormData.yourBirthPlace}
    onChange={(e) =>
      setPopupFormData({ ...popupFormData, yourBirthPlace: e.target.value })
    }
  />

  <hr className="my-4" />

  <h3 className="text-md font-medium text-gray-700">Partner Details</h3>

  <Input
    placeholder="Partner Full Name"
    value={popupFormData.partnerName}
    onChange={(e) =>
      setPopupFormData({ ...popupFormData, partnerName: e.target.value })
    }
  />
  ...
  <div className="grid grid-cols-2 gap-3">
    <Input
      type="date"
      value={popupFormData.partnerBirthDate}
      onChange={(e) =>
        setPopupFormData({ ...popupFormData, partnerBirthDate: e.target.value })
      }
    />
    <Input
      type="time"
      value={popupFormData.partnerBirthTime}
      onChange={(e) =>
        setPopupFormData({ ...popupFormData, partnerBirthTime: e.target.value })
      }
    />
  </div>

  <Input
    placeholder="Partner Place of Birth"
    value={popupFormData.partnerPlaceOfBirth}
    onChange={(e) =>
      setPopupFormData({ ...popupFormData, partnerPlaceOfBirth: e.target.value })
    }
  />
